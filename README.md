...
## บันทึกผลการทดลอง
 ...
 จากการทดลองพบว่า สามารถสร้าง MessageBox ได้จากโค๊ดดังกล่าวโดยสามารถเลือกรูปแบบ Messagebox โดยการเปลี่ยน MB_(รูปแบบที่ต้องการ)
...
```
![](https://github.com/Mustted/LAB-01/blob/master/EasyMain.png?raw=true)				
